...
<div>
<form method="post" action="product!productInSto.action?prodId=${product.prodId}">
<table align="center" cellpadding="0" cellspacing="0">
<thead><span id="bar"><p align="left" class="STYLE6">>>商品入库登记（注：带<strong><span class="STYLE11">*</span></strong>号的为必填）</p></span></thead>
<tbody>
<tr>
  <td colspan="2"><a href="product!showAllProduct.action" class="STYLE19">返回</a></td>
    </tr>
    <tr>
	...
	<tr>
	<td><p align="right"><span class="STYLE5"> 入库编号：</span></p></td>
     <td>  <input name="inOrderId" type="text" id="inOrderId" /><span id="IDhint"></span> <span class="STYLE11">*</span></td>
     </tr>
     <tr> 
	 <td><p align="right"><span class="STYLE5">数量：</span></p></td>
	  ...
	  <td><p align="right"><span class="STYLE5">负责人：</span></p></td>　
        <td>
		 <select id="managerId" style="width:150px;" name="manager.managerName" value="${manager.managerName }">
    	<option value="-1">--请选择--</option>
      </select><span class="STYLE11">*</span>　
		</td>
		</tr>
      <tr>
	  <td><p align="right"><span class="STYLE5">操作员：</span></p></td>　
        <td><input name="operator" type="text" id="operator"  value='${sessionScope.currentAdmin.getAdminName()}' readonly="readonly"/><span class="STYLE11">*</span>　</td>
		</tr>
      <tr>
	  <td><p align="right"><span class="STYLE5">入库日期：</span></p></td>　
