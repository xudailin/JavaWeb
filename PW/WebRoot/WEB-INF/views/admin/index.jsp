...
<head>
	...
	<title>Personal Website1.0</title>
</head> 
  <body>
    <!-- start: Header -->
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
	        ...
	        <ul class="nav navbar-nav navbar-right" style="margin-right: 20px;">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="static/img/avatar1.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="static/img/avatar2.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="static/img/avatar3.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="static/img/avatar4.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="static/img/avatar5.jpg">
								<div>New message</div>
				...
				<li class="dropdown visible-md visible-lg">
	        		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="user-avatar" src="${staticPath}/${currentUser.headimgurl}" alt="user-mail">${currentUser.loginname}</a>
	        		<ul class="dropdown-menu">
						<li class="dropdown-menu-header">
							<strong>Account</strong>
						</li>						
						<li><a href="page-profile.html"><i class="fa fa-user"></i> Profile</a></li>
						<li><a href="javaScript:$.openHTML('${staticPath }/after/userInfo.html');"><i class="fa fa-wrench"></i> Settings</a></li>
			...
			<div class="sidebar ">
				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							<li><a href="welcomePage.html" data-load=""><i class="fa fa-laptop"></i><span class="text"> 首页</span></a>
							</li>
							<li>
								<a href="#"><i class="fa fa-file-text"></i><span class="text"> 博客模块</span> <span class="fa fa-angle-down pull-right"></span></a>
								<ul class="nav sub">
									<li><a href="blogTypePage.html" data-load=""><i class="fa fa-sitemap"></i><span class="text"> 类型管理</span></a></li>
									<li><a href="blogPage.html" data-load=""><i class="fa fa-file"></i><span class="text"> 博客管理</span></a></li>
									<li><a href="blogCommentPage.html" data-load=""><i class="fa fa-comments"></i><span class="text"> 评论管理</span></a></li>						
									<li><a href="blogLinkPage.html" data-load=""><i class="fa fa-link"></i><span class="text"> 友情链接</span></a></li>
									<li><a href="blogMessagePage.html" data-load=""><i class="fa fa-envelope"></i><span class="text"> 留言板</span></a></li>
									<li><a href="userInfo.html" data-load=""><i class="fa fa-user"></i><span class="text"> 个人信息</span></a></li>									
								</ul>	
							</li>
						</ul>
					</div>					
				...
				<div class="sidebar-footer">					
					...
					<div class="copyright text-center">
						<small>WebSite <i class="fa fa-coffee"></i> from <a href="#" title="前端访问" target="_blank">前端访问</a></small>
					</div>					
				</div>	
