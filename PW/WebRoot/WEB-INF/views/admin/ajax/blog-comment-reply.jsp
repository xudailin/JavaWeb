...
<form id="replyForm" method="post">
	<div class="comment-content">
		...
		<div class="reply">
			<textarea name="comcontent" id="myReply" rows="3" class="reply-content" placeholder="回复${blogComment.commenter.nickname}:"></textarea>
		</div>
	</div>
...
(function($){
	$(function(){
		$("#replyForm").submit(function(){
			...
			$.post('${staticPath }/after/replyComment.html',
